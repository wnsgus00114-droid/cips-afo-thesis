...
python3 experiments/scripts/run_sweeps.py --num-tokens 64 --seeds 11,23 >/dev/null
python3 experiments/scripts/plot_results.py >/dev/null
python3 experiments/scripts/gen_baselines.py >/dev/null
python3 experiments/scripts/sanity_validate.py >/dev/null
python3 experiments/scripts/analyze_results.py >/dev/null
